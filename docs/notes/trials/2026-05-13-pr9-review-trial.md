...
- Subject PR: `5fed5fd` (PR #9 — dogfood: check in this repo's own `.contextspec/`).
  Diff saved at `docs/notes/trials/.work/pr9-diff.patch` (1098 lines, 28 files).
- Pack — engineer-review for `finish-line`:
  `docs/notes/trials/.work/pack-engineer.md` (526 lines, generated from current main).
- Pack — pm-review for `finish-line`:
  `docs/notes/trials/.work/pack-pm.md` (489 lines).
...
- `docs/notes/trials/.work/pr9-diff.patch` — `git show 5fed5fd`
- `docs/notes/trials/.work/pack-engineer.md` — `contextspec pack --role engineer --initiative finish-line --task review`
- `docs/notes/trials/.work/pack-pm.md` — `contextspec pack --role pm --initiative finish-line --task review`

They are gitignored (`docs/notes/trials/.work/`) rather than committed: packs
