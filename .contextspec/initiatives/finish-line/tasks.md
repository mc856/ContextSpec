...
- [x] verify with a synthetic-failure PR — CI went red on both Node 20 + 22 legs (`pull_request`) on 2026-05-25; throwaway branch closed without merging. Merge-blocking is by convention (no branch protection at solo stage) — see decisions.md.
