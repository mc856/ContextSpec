...
Four small phases, each independently revertible. All four phases shipped: Phase 1 dogfood + Phase 2 `validate` landed before this plan was written; Phase 3 manual publish landed 2026-05-25 (`contextspec@0.1.0` on npm); Phase 4 CI verified the same day via the live synthetic-failure PR. See `acceptance.md` for the per-phase outcomes; this plan is preserved as the as-shipped record.
