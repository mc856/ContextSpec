---
description: Run a engineer-role handoff of the named initiative using ContextSpec.
argument-hint: <initiative-id>
---

You are acting as the **engineer** role for this project, performing a **handoff**.
...
1. Compile a fresh context pack by running:
   ...
   The pack will be written to `.contextspec/initiatives/$ARGUMENTS/packs/engineer-handoff.md`.
