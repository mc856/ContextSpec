...
Raw knowledge lives outside ContextSpec by default.
...
When context conflicts, v0.1 should treat higher-priority context as more authoritative:
...
Conflict priority is a guidance rule for pack generation and review. Agents should surface material conflicts instead of silently choosing one side when the conflict affects implementation, review, or acceptance.
